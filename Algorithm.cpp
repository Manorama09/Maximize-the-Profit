...
cout<<"\t\t| S. No. | ITEM NAME | PRICE | PROFIT (IN RS) |\n";
...
{
cout<<endl;
cout<<"The Maximum Profit we get is : ";
cout<<res<<endl<<endl;
cout<<"The STOCK ITEMS are : "<<endl<<endl;
...
{
cout<<"\t\t|"<<setw(4)<<k<<")"<<setw(5)<<"|"<<setw(48)<<items[i]<<setw(6)<<"|"<<setw(14)<<
wt[i-1]<<setw(10)<<"|"<<setw(12)<<val[i-1]<<setw(8)<<"|"<<endl;
res=res-val[i-1];
w=w-wt[i-1];
k++;
}
